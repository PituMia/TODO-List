            ...
            <div className="task container d-flex justify-content-between align-items-center p-3" >
                <div className="col-10 text-truncate d-flex align-items-center">
                    ...
                    style={{
                        ...
                        textDecorationColor: checkBtn ? 'rgba(0, 255, 0, 0.6)' : 'transparent',  // Verde más brillante y algo transparente
                        textDecorationThickness: checkBtn ? '4px' : '0'  // Aumento el grosor a 4px
                    }}>
                        {todo}</h1>
                </div>
