    ...
    return (
        !thrashBtn ? (
            <div className="task container d-flex justify-content-between align-items-center p-3" >
                <div className="col-10 text-truncate d-flex align-items-center" style={{
                        textDecoration: checkBtn ? 'line-through' : 'none',
                        textDecorationColor: checkBtn ? 'green' : 'transparent',
                        textDecorationThickness: checkBtn ? '2px' : '0'
                    }}>
                    <h1>{todo}</h1>
                </div>
